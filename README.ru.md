...
**🤖 Агентам:** [MCP-сервер кита](mcp/README.ru.md) — пакеты, пропсы, примеры и правила репы без вычитывания исходников; зависимостей нет. Работает по stdio (рядом с рабочей копией) и по HTTP: `claude mcp add --transport http solid-dumb-kit https://solid-dumb-kit.vercel.app/mcp` — одним адресом, без клона.
