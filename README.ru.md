...
**🤖 Агентам:** [MCP-сервер кита](mcp/README.ru.md) — пакеты, пропсы, примеры и правила репы без вычитывания исходников; зависимостей нет. Работает по stdio (рядом с рабочей копией) и по HTTP (одним адресом, без клона).
