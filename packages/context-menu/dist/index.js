import { delegateEvents, createComponent, effect, setStyleProperty, use, insert, className, setAttribute, style, template } from 'solid-js/web';
...
var _tmpl$5 = /* @__PURE__ */ template(`<li><button type=button role=menuitem class=dumb-menu-item><span class=dumb-menu-label>`);
var _tmpl$6 = /* @__PURE__ */ template(`<li class=dumb-menu-sep role=separator>`);
var STYLES = `
...
function DumbContextMenu(props) {
  ...
  const pickable = () => items().map((it, i) => ({
    it,
    i
  })).filter(({
    it
  }) => it.kind !== "separator" && !it.disabled);
  function close() {
    if (!open()) return;
  ...
  createEffect(() => {
    ...
    const track = (ev) => {
      ...
      Array.from(box?.querySelectorAll(".dumb-menu-item") ?? []);
      ...
      return [(() => {
        ...
        insert(_el$3, createComponent(For, {
          ...
          children: (it, i) => createComponent(Show, {
            ...
            get children() {
              var _el$4 = _tmpl$5(), _el$5 = _el$4.firstChild, _el$7 = _el$5.firstChild;
              _el$5.$$click = () => {
                it.run();
                close();
              };
              _el$5.addEventListener("mouseenter", () => setActive(i()));
              insert(_el$5, createComponent(Show, {
                ...
                get children() {
                  var _el$6 = _tmpl$3();
                  effect(() => className(_el$6, `dumb-menu-icon ${it.icon}`));
                  return _el$6;
                }
              }), _el$7);
              insert(_el$7, () => it.label);
              insert(_el$5, createComponent(Show, {
                get when() {
                  return it.hint;
                },
                get children() {
                  var _el$8 = _tmpl$4();
                  insert(_el$8, () => it.hint);
                  return _el$8;
                }
              }), null);
              effect((_p$) => {
                var _v$5 = active() === i() ? "1" : void 0, _v$6 = it.danger ? "1" : void 0, _v$7 = it.disabled;
                _v$5 !== _p$.e && setAttribute(_el$5, "data-active", _p$.e = _v$5);
                _v$6 !== _p$.t && setAttribute(_el$5, "data-danger", _p$.t = _v$6);
                _v$7 !== _p$.a && (_el$5.disabled = _p$.a = _v$7);
                return _p$;
              }, {
                e: void 0,
                t: void 0,
        ...
        effect((_p$) => {
          var _v$3 = `dumb-menu ${props.class ?? ""}`, _v$4 = place();
...
var _tmpl$7 = /* @__PURE__ */ template(`<div class=dumb-pop-anchor>`);
