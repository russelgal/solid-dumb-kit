...
// src/DumbGallery.tsx
var _tmpl$ = /* @__PURE__ */ template(`<button type=button>\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0444\u0430\u0439\u043B\u044B`);
var _tmpl$2 = /* @__PURE__ */ template(`<span data-gallery-stats>`);
var _tmpl$3 = /* @__PURE__ */ template(`<div><div class=dumb-gallery>`);
var _tmpl$4 = /* @__PURE__ */ template(`<button type=button title=\u0443\u0431\u0440\u0430\u0442\u044C>\u2715`);
...
function DumbGallery(props) {
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(DumbSortable, {
      get items() {
        return props.items;
      },
      get setItems() {
      ...
      children: (item, i) => props.children?.(item, i) ?? (() => {
        var _el$5 = _tmpl$6(), _el$6 = _el$5.firstChild;
        _el$5.$$click = () => props.onOpen?.(item, i());
        ...
        insert(_el$5, createComponent(Show, {
          ...
          get children() {
            ...
            effect((_$p) => setStyleProperty(_el$9, "width", `${Math.round((item.progress ?? 0) * 100)}%`));
            return _el$8;
          }
        }), null);
        effect((_p$) => {
          var _v$5 = item.status ?? "local", _v$6 = item.error ?? item.name, _v$7 = item.preview ?? item.url, _v$8 = item.name ?? "";
          _v$5 !== _p$.e && setAttribute(_el$5, "data-status", _p$.e = _v$5);
          _v$6 !== _p$.t && setAttribute(_el$5, "title", _p$.t = _v$6);
          _v$7 !== _p$.a && setAttribute(_el$6, "src", _p$.a = _v$7);
          _v$8 !== _p$.o && setAttribute(_el$6, "alt", _p$.o = _v$8);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        var _el$3 = _tmpl$();
        _el$3.$$click = () => picker.selectFiles(accepted);
        return _el$3;
      }
    }), null);
    insert(_el$, createComponent(Show, {
    ...
    effect((_p$) => {
      var _v$ = `dumb-gallery-drop ${props.class ?? ""}`, _v$2 = dragOver() && editable() ? "1" : void 0, _v$3 = props.style, _v$4 = tile();
      _v$ !== _p$.e && className(_el$, _p$.e = _v$);
      _v$2 !== _p$.t && setAttribute(_el$, "data-over", _p$.t = _v$2);
      _p$.a = style(_el$, _v$3, _p$.a);
      _v$4 !== _p$.o && setStyleProperty(_el$2, "--dumb-gallery-tile", _p$.o = _v$4);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
