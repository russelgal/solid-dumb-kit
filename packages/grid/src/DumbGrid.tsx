...
/**
 * Цвет линий разметки. Нейтральный серый читается и на светлом, и на тёмном, но
 * потребитель с темой перебивает его переменной — иначе в тёмной теме линии
 * либо тонут, либо режут глаз.
 */
const GRID_LINE = 'var(--dumb-grid-line, rgba(100,116,139,.45))'
