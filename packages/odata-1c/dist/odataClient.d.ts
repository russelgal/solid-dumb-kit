...
export declare function toBase64(s: string): string;
/** Экранирование строки для `$filter`: апостроф удваивается */
export declare function odataString(s: string): string;
...
export declare function createOdataClient(opts: OdataClientOptions): OdataClient;
