 ...
 */
export { SCALES, clampEdge, closesAtNight, columns, confined, conflicts, dayBounds, rowBounds, floorsPerRow, fromX, headGroups, lengthOf, minLength, minutesOf, momentX, moveTo, snapEdge, snapOf, stackFloors, toMinutes, toMoment, toX, totalCols, type Moment, type RowRules, type Scale, } from './scale';
