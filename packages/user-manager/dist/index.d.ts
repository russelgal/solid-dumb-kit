...
declare function DumbUserManager(props: DumbUserManagerProps): JSX.Element;
 ...
 */
declare function suggestPassword(length?: number): string;

export { DumbUserManager, type DumbUserManagerProps, type RoleOption, type UserManagerLabels, type UserRow, suggestPassword };
